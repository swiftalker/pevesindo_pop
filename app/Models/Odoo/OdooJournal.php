...
use Carbon\Carbon;
use Database\Factories\OdooJournalFactory;
 ...
 */
class OdooJournal extends Model
{
    use HasFactory;
     ...
     */
    protected static function newFactory(): OdooJournalFactory
    {
        return OdooJournalFactory::new();
    }
}
