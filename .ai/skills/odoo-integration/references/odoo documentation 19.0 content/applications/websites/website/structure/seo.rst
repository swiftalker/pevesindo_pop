...
.. note::
   ...
   - All provided :doc:`themes <../web_design/themes>` are built with the `Bootstrap
     <https://getbootstrap.com/>`_ CSS framework to ensure responsive layouts across desktop,
...
- Implement :ref:`redirects <website/pages/URL-redirection>` from old URLs to their new
  counterparts.
