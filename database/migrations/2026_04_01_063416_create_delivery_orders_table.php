...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('delivery_orders', function (Blueprint $table) {
            ...
            $table->foreignId('fsm_task_id')->nullable()->constrained('tasks')->cascadeOnDelete()->cascadeOnUpdate();
            $table->integer('odoo_id')->nullable()->index();
            $table->string('name')->nullable();
            $table->foreignId('partner_id')->constrained()->cascadeOnDelete()->cascadeOnUpdate();
            $table->foreignId('warehouse_id')->nullable()->constrained()->cascadeOnDelete()->cascadeOnUpdate();
