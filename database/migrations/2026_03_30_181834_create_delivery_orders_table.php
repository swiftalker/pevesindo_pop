...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('delivery_orders', function (Blueprint $table) {
            ...
            $table->foreignId('sale_order_id')->nullable()->constrained()->cascadeOnDelete()->cascadeOnUpdate();
            $table->foreignId('fsm_task_id')->nullable()->constrained()->cascadeOnDelete()->cascadeOnUpdate();
            ...
            $table->foreignId('odoo_vehicle_id')->nullable()->constrained()->cascadeOnDelete()->cascadeOnUpdate();
