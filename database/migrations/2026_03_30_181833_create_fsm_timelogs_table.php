...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('fsm_timelogs', function (Blueprint $table) {
            $table->id();
            $table->uuid('center_app_ref')->unique();
            $table->foreignId('fsm_task_id')->constrained()->cascadeOnDelete()->cascadeOnUpdate();
    ...
    {
        Schema::dropIfExists('fsm_timelogs');
    }
};
