...
employees earn overtime, and at what rate.

.. important::
   No overtime rulesets come preconfigured in the **Attendances** app; all overtime rulesets must be
   created.
...
Overtime Rulesets`. Any existing overtime rulesets appear in a default list view, and display the
...
- :guilabel:`Rate Combination Mode`: Using the drop-down menu, select how the overtime rate is
  ...
  - :guilabel:`Sum of all rates`: A combination of all applicable overtime rates is used to
    calculate the overtime pay. Odoo calculates the rate by adding the *extra* pay rates (above
    100%).
...
- :guilabel:`With a tolerance in favor of the employee of`: Enter the amount of extra time given to
  ...
  employee logs an 8 hour and 48 minute workday, the missing 12 minutes **are** counted as overtime,
